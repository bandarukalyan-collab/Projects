...
A React + Node web app to search a YouTube channel, list its top 5 recent videos, open a selected video, generate a quick AI summary, and export that summary for sharing.
...
- Exports summaries as PDF, DOCX, or PPTX.
...
After a summary is generated, use the export buttons to download:

- PDF for quick sharing
- DOCX for editing notes
- PPTX for a small slide deck
...
7. `POST /api/export-summary` generates PDF, DOCX, and PPTX downloads from the summary.
